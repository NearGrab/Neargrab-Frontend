...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="w-full bg-white border border-neutral-100/90 rounded-2xl p-2.5 sm:p-3.5 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col group relative select-none text-left">
      ...
      <div className="w-full aspect-square rounded-xl bg-white overflow-hidden mb-2 sm:mb-3.5 flex items-center justify-center relative border border-neutral-50/50 p-2 sm:p-3">
        <img
          src={product.image}
          alt={product.name}
      ...
      <div className="flex-grow flex flex-col">
        {/* Title */}
        <h4 className="font-inter font-bold text-xs sm:text-sm text-text-primary line-clamp-2 leading-snug group-hover:text-brand-900 transition-colors mb-0.5 sm:mb-1 min-h-[2rem] sm:min-h-[2.5rem]">
          {product.name}
        </h4>
        ...
        <div className="flex items-baseline gap-1.5 sm:gap-2 mb-2 sm:mb-3.5">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
          ...
          <div className="flex items-center gap-1 min-w-0">
            ...
            {product.verified && (
              <span className="w-3 h-3 sm:w-3.5 sm:h-3.5 bg-brand-900 text-white rounded-full flex items-center justify-center shrink-0" style={{ transform: 'scale(0.75)' }}>
