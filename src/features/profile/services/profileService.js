...
const STATIC_WHO_TO_FOLLOW = [
  { id: 1, name: "Aarav Mehta", username: "aarav_explore", avatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=100&q=80", following: false },
  { id: 2, name: "Priya Sharma", username: "priya_finds", avatar: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=100&q=80", following: false },
  { id: 3, name: "Kabir Patel", username: "kabir_local", avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=100&q=80", following: false }
];

const STATIC_BADGES = [
  { id: 4, name: "Early Supporter", level: 1, type: "brand" }
];
...
export const profileService = {
  ...
  async getProfileData(username = null) {
    ...
    return {
      currentUser,
      impact,
      badges: badges.length > 0 ? badges : STATIC_BADGES,
      reviews,
      whoToFollow: profile?.whoToFollow || STATIC_WHO_TO_FOLLOW,
