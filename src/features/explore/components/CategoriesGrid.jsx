...
const CategoryIcons = {
  ...
  bakery: () => (
    <svg className="w-8 h-8" viewBox="0 0 48 48" fill="none">
      <path d="M12 24C12 18 16 14 24 14C32 14 36 18 36 24V38H12V24Z" fill="#FEF3C7" stroke="#D97706" strokeWidth="2.5" />
      <path d="M8 38H40" stroke="#D97706" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M18 20C18 20 20 18 24 18C28 18 30 20 30 20" stroke="#D97706" strokeWidth="2" strokeLinecap="round" />
      <path d="M17 28H31" stroke="#F59E0B" strokeWidth="2" />
      <path d="M17 33H31" stroke="#F59E0B" strokeWidth="2" />
    </svg>
  ),
  clothing: () => (
    <svg className="w-8 h-8" viewBox="0 0 48 48" fill="none">
      <path d="M9 16L15 10L20 12V38H9V16Z" fill="#EEF2FF" stroke="#4F46E5" strokeWidth="2.5" strokeLinejoin="round" />
      <path d="M39 16L33 10L28 12V38H39V16Z" fill="#EEF2FF" stroke="#4F46E5" strokeWidth="2.5" strokeLinejoin="round" />
      <path d="M20 12L24 14L28 12V38H20V12Z" fill="#E0E7FF" stroke="#4F46E5" strokeWidth="2.5" strokeLinejoin="round" />
      <path d="M18 10C20 10 21 8 24 8C27 8 28 10 30 10" stroke="#4F46E5" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  ),
  pharmacy: () => (
    <svg className="w-8 h-8" viewBox="0 0 48 48" fill="none">
      <rect x="10" y="16" width="28" height="20" rx="4" fill="#FEE2E2" stroke="#EF4444" strokeWidth="2.5" />
      <path d="M24 21V31" stroke="#EF4444" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M19 26H29" stroke="#EF4444" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M18 16V10C18 8.89543 18.8954 8 20 8H28C29.1046 8 30 8.89543 30 10V16" stroke="#EF4444" strokeWidth="2.5" />
    </svg>
  ),
  medicine: () => (
    <svg className="w-8 h-8" viewBox="0 0 48 48" fill="none">
    ...
    <div className="w-full mt-6 md:mt-8">
      ...
      <div className="flex items-center gap-4 overflow-x-auto py-2 px-4 md:px-1 scrollbar-none snap-x snap-mandatory">
        {categories.map((cat) => {
          ...
          const iconKey = String(cat.icon || cat.name || '').toLowerCase().replace(/[^a-z0-9]/g, '');
          const IconComponent = CategoryIcons[iconKey] || CategoryIcons.more;
